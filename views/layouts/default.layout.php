                    ...
                    <?php if (empty($user)): ?>
                        ...
                        <li class="nav-item ">
                            <a class="nav-item nav-link mr-md-2" id="bd-versions" aria-haspopup="false"
                               aria-expanded="false" href="<?= Registry::get(\App\Registry::ROUTER)->generate("login") ?>">
                                Log in
                            </a>
                        ...
                        <li class="nav-item">
                            <a class="nav-item nav-link" aria-haspopup="false" aria-expanded="false"
                               href="<?= Registry::get(\App\Registry::ROUTER)->generate("register") ?>">
                                Register
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-item nav-link mr-md-2" id="bd-versions" aria-haspopup="false"
                               aria-expanded="false" href="<?= Registry::get(\App\Registry::ROUTER)->generate("loggout") ?>">
                                Log out
                            </a>
